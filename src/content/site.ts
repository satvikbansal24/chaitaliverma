...
export const site = {
  ...
  heroImages: [
    ...
    { src: "/hero-05.png", alt: "Chaitali with a view over the city at golden hour", objectPosition: "center 35%" },
    { src: "/hero-03.png", alt: "Chaitali with a city skyline and bridge", objectPosition: "center 40%" },
    { src: "/hero-04.png", alt: "Chaitali reading by the water", objectPosition: "center 38%" },
    { src: "/hero-02.png", alt: "Chaitali enjoying food indoors", objectPosition: "center 45%" },
